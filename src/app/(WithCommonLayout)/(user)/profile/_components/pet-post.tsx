            ...
            <div className="max-w-2xl mx-auto h-[525px] p-4 shadow-md ">
                <div className="flex items-start space-x-3">
                    <div className="flex-1">
                        <textarea
                            className="w-full h-12 p-2 border border-gray-300  resize-none"
                        ...
                        />
                        <select
                            className="w-full p-2 border border-gray-300  mt-6"
                            value={category}
                        ...
                        <p className='text-xl border p-2 border-gray-300 mt-6 mb-2'>Do you want to make this post premium?</p>
                        <select
                            className="w-full p-2 border border-gray-300  mt-6"
                            value={isPremium}
