...
const Page = () => {
  ...
  return <Card className=" lg:w-[300px] rounded-md ml-10 mr-6">
            ...
            <CardBody>
                <Image src={info?.profilePhoto} width={300} height={300} alt="Profile Photo" />
                <div>
                <p> Followers </p>
                    {followers?.map((follower : TFollower) => <div key={follower.id}>
                       <div>
                       <p>{follower.username}</p>
                       <Image src={follower?.profilePhoto} width={100} height={100} alt="Follwer profile photo" />
                       </div>
