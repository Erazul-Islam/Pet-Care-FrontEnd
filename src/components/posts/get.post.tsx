              ...
              return (
                <div key={index}>
                  <div className="shadow-md  border border-purple-200 rounded-lg p-4 max-w-screen-md">
                    ...
                    <CommentSection commentText={commentText} setCommentText={setCommentText} handleAddComment={handleAddComment} post={post} openEditModal={openEditModal} handleDeleteComment={handleDeleteComment} />
